...
python3 scripts/preprocess/preprocess_raganato.py \
    --data data/original/wsd_hard_benchmark/ALLamended/ALLamended.data.xml \
    --keys data/original/wsd_hard_benchmark/ALLamended/ALLamended.gold.key.txt \
    --output data/preprocessed/wsd_hard_benchmark/ALLamended/ALLamended.json \
    --use_document_context \
    --replace_sentences

python3 scripts/preprocess/preprocess_raganato.py \
    --data data/original/wsd_hard_benchmark/hardEN/hardEN.data.xml \
    --keys data/original/wsd_hard_benchmark/hardEN/hardEN.gold.key.txt \
    --output data/preprocessed/wsd_hard_benchmark/hardEN/hardEN.json \
    --use_document_context \
    --replace_sentences
